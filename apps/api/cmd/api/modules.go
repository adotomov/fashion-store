...
var defaultUIStrings = map[string]string{
	...
	"home.slider_prev":         "Previous",
	"home.view_all_discounted": "View All Discounted Products",

	// Shop / Browse
	"shop.all_products":       "All Products",
	"shop.clear_filters":      "Clear all",
	"shop.filter_category":    "Category",
	"shop.filter_offers":      "Offers",
	"shop.filter_on_sale":     "On Sale",
	...
	// Cart
	"cart.added_toast":        "Added to your cart",
	...
	"cart.out_of_stock":       "Out of stock — remove to continue",
	"cart.remove_error":       "Could not remove this item.",
	"cart.remove_item":        "Remove item",
	"cart.remove_unavailable": "Remove the out-of-stock items to continue.",
	...
	"checkout.cancelling_payment":       "Cancelling…",
	"checkout.card_details_label":       "Card details",
	"checkout.card_invalid_error":       "Please check your card details and try again.",
	...
	"checkout.card_online_next_step":    "You'll enter your card, or use Apple Pay / Google Pay, on the next step.",
	...
	"checkout.choose_office":            "Choose an office",
	"checkout.complete_order":           "Complete Order",
	"checkout.confirming_payment":       "Confirming your payment…",
	"checkout.confirming_payment_hint":  "This only takes a moment.",
	...
	"checkout.continue_to_pay":          "Continue to Payment",
	...
	"checkout.load_offices_error":       "Could not load pickup points for this city.",
	...
	"checkout.no_offices_found":         "No offices found for this city.",
	"checkout.or_pay_by_card":           "or pay by card",
	...
	"checkout.out_of_stock_desc":        "We couldn't reserve everything in your cart. Please review and remove the out-of-stock items to continue.",
	"checkout.out_of_stock_title":       "Some items are no longer in stock",
	"checkout.pay":                      "Pay",
	"checkout.pay_amount_prompt":        "Enter your card details, or use Apple Pay / Google Pay.",
	"checkout.pay_by_card":              "Pay by Card",
	...
	"checkout.payment_widget_error":     "Could not load the payment form. Please try again.",
	"checkout.pick_city_for_lockers":    "Pick a city to see nearby lockers.",
	"checkout.pick_city_for_offices":    "Pick a city to see nearby offices.",
	"checkout.pickup_city":              "City",
	...
	"checkout.secure_payment_banner":    "Secure payment",
	"checkout.select_locker":            "Select a locker",
	"checkout.select_office":            "Select an office",
	...
	"checkout.start_payment_error":      "Could not start the payment. Please try again.",
	"checkout.starting_payment":         "Starting payment…",
	...
	"checkout.use_different_method":     "Use a different payment method",

	// Address form (Speedy-resolved)
	"address.apartment_no":        "Apartment",
	"address.block_no":            "Block",
	"address.city":                "City",
	"address.city_placeholder":    "Start typing a city…",
	"address.complex":             "Neighbourhood (кв./жк.)",
	"address.complex_placeholder": "Start typing…",
	"address.country":             "Country",
	"address.country_bg":          "Bulgaria",
	"address.floor_no":            "Floor",
	"address.no_cities":           "No cities found",
	"address.no_complexes":        "No neighbourhoods found",
	"address.no_streets":          "No streets found",
	"address.phone":               "Phone",
	"address.pick_city_first":     "Pick a city first",
	"address.recipient_name":      "Recipient name",
	"address.street":              "Street",
	"address.street_no":           "Street No.",
	"address.street_placeholder":  "Start typing…",
	...
	// Auth — phone setup gate
	"auth.phone_setup.add_cta":       "Save & Continue",
	"auth.phone_setup.add_title":     "Add your phone number",
	"auth.phone_setup.confirm_cta":   "Confirm & Continue",
	"auth.phone_setup.confirm_title": "Confirm your phone number",
	"auth.phone_setup.required":      "Please enter a phone number to continue.",
	"auth.phone_setup.save_error":    "Could not save your phone number. Please try again.",
	"auth.phone_setup.sign_out":      "Not now — sign out",
	...
	"account.profile.phone_required":   "A phone number is required so we can reach you about your orders.",
